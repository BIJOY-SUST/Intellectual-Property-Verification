...
async function main(email) {
    try {
        ...
        console.log(`Wallet path(allRequests): ${walletPath}`);
        ...
        console.log('will now go to chaincode with receiverEmail: '+email);
        const result = await contract.evaluateTransaction('getReq',email);
